...
public class XMLDAOTest {
	...
	public List<PartyContact> setList(){
		...
		pc1 = new PartyContact.PartyContactBuilder()
		...
		pc2 = new PartyContact.PartyContactBuilder()
		.withLastName("Bill").withFirstName("Ader")
		.withSecondName("Nick").withMobilePhone("896585588")
		.withHomePhone("345235").withPostalAdress("Ukraine").withEMail("89000@tyr.com").build();
